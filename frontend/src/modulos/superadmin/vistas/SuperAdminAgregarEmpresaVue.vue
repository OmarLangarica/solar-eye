<template>
    <div class="contenedor">
        <div class="encabezado">
            <div>
                <h1>Nueva empresa</h1>
                <p>Registra una nueva empresa en Solar Eye</p>
            </div>
                ...
                <div class="fila-doble">
                    <div class="grupo">
                        ...
                        <div class="color-grupo">
                            ...
                            <input v-model="form.color_primario" type="text" placeholder="#FF7043" class="input-hex" />
                        </div>
                    </div>
                    <div class="grupo">
                        ...
                        <div class="color-grupo">
                            ...
                            <input v-model="form.color_secundario" type="text" placeholder="#F4511E" class="input-hex" />
                        </div>
                    </div>
                </div>
