    ...
    <div class="contenedor">
        ...
        <nav class="navbar">
            ...
            <div class="navbar-links">
                <button class="nav-link" @click="volverPaso2">← Volver</button>
...
const { cargando, error, guardarConsumoElectrico, guardarResultados, calcularResultadosPvlib, obtieneConsumoElectrico, cargandoIA, extraerDatosConIA } = useSimulaciones();
...
<style scoped>
.contenedor { padding: 0 0 2rem; max-width: 1100px; margin: 0 auto; }
