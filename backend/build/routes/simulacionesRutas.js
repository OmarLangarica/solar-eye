...
router.get('/techo/:simulacion_id', async (req, res) => {
    try {
...
router.post('/techo', async (req, res) => {
    try {
...
router.put('/techo', async (req, res) => {
    try {
...
router.get('/geograficos/:simulacion_id', async (req, res) => {
    try {
...
router.post('/geograficos', async (req, res) => {
    try {
...
router.get('/consumo/:simulacion_id', async (req, res) => {
    try {
...
router.put('/consumo', async (req, res) => {
    try {
...
router.get('/sistema/:simulacion_id', async (req, res) => {
    try {
...
router.get('/resultados/:simulacion_id', async (req, res) => {
    try {
...
// PUT geograficos
router.put('/geograficos', async (req, res) => {
    try {
